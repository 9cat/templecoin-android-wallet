...
public class Constants {
	...
	public static final String WALLET_FILENAME = "wallet"
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = CoinDefinition.coinName
			+ "-wallet-keys" + FILENAME_NETWORK_SUFFIX;
	...
	public static final String EXPLORE_BASE_URL = NETWORK_PARAMETERS.getId()
			.equals(NetworkParameters.ID_MAINNET) ? EXPLORE_BASE_URL_PROD
			: EXPLORE_BASE_URL_TEST;

	public static final String MIMETYPE_TRANSACTION = "application/x-"
			+ CoinDefinition.coinTicker.toLowerCase() + "tx";
	...
	public static final String CURRENCY_CODE_MBTC = "m"
			+ CoinDefinition.coinTicker;// "BTC";
	...
	public static final String REPORT_EMAIL = "templecoin@gmail.com";
	...
	public static final String SOURCE_URL = "https://github.com/9cat/Templecoin-Android-wallet";
	public static final String BINARY_URL = "http://code.google.com/p/bitcoin-wallet/downloads/list";
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/9cat/templecoinj";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
	public static final String CREDITS_WEBSITE_URL = "http://www.templecoin.com";
	public static final String CREDITS_FORUM_URL = "http://www.templecoin.com";
	public static final String CREDITS_ICON_URL = "http://www.templecoin.com";

	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/#!/tpcoin";
	public static final String AUTHOR_GOOGLEPLUS_URL = "https://profiles.google.com/templecoin";

	public static final String COMMUNITY_GOOGLEPLUS_URL = "https://plus.google.com/u/1/b/109773245489123009143/communities/116619735536582663161";

	public static final String MARKET_APP_URL = "market://details?id=%s";
	public static final String WEBMARKET_APP_URL = "https://play.google.com/store/apps/details?id=%s";
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"temple\"";
