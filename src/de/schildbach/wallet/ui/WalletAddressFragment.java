...
import de.schildbach.wallet.templecoin.R;
...
public final class WalletAddressFragment extends Fragment {
	...
	public void onAttach(final Activity activity) {
		...
		this.nfcManager = (NfcManager) activity
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		final View view = inflater.inflate(R.layout.wallet_address_fragment,
				container, false);
		bitcoinAddressButton = view.findViewById(R.id.bitcoin_address_button);
		bitcoinAddressLabel = (TextView) view
				.findViewById(R.id.bitcoin_address_label);
		bitcoinAddressQrView = (ImageView) view
				.findViewById(R.id.bitcoin_address_qr);
